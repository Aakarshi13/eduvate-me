...
export interface UserSeedData {
  email: string;
  password: string; // Plain text password for seeding, will be hashed
  name?: string;
}
...
export const colleges: College[] = [
  ...
  },
  {
    ...
    cutoffs: {
      cuet: [
        { year: 2024, general: 378, obc: 331, sc: 290, st: 275, ews: 350 },
        { year: 2023, general: 360, obc: 315, sc: 275, st: 260, ews: 330 },
        { year: 2022, general: 340, obc: 300, sc: 260, st: 245, ews: 310 }
      ]
    },
  ...
  // ============ AKTU Affiliated Colleges ============
  {
    ...
    cutoffs: {
      jee: [
        ...
        { year: 2023, general: 49385, obc: 57203, sc: 192032, st: 167380, ews: 45811 },
        { year: 2022, general: 47203, obc: 54803, sc: 183203, st: 159380, ews: 43611 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs', 'Cafeteria'],
  ...
  },
  {
    ...
    cutoffs: {
      jee: [
        ...
        { year: 2023, general: 62335, obc: 71803, sc: 210032, st: 183380, ews: 57811 },
        { year: 2022, general: 59803, obc: 68903, sc: 201203, st: 175380, ews: 55211 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs'],
    courses: ['B.Tech', 'M.Tech'],
  ...
  },
  {
    ...
    cutoffs: {
      jee: [
        ...
        { year: 2023, general: 69235, obc: 79803, sc: 232032, st: 202380, ews: 64811 },
        { year: 2022, general: 66503, obc: 76603, sc: 223203, st: 194380, ews: 62111 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs'],
    courses: ['B.Tech', 'M.Tech'],
  ...
  },
  {
    ...
    placementRate: 70,
    topRecruiters: ['TCS', 'Infosys', 'Wipro', 'L&T', 'HCL'],
    cutoffs: {
      jee: [
        { year: 2024, general: 80058, obc: 92231, sc: 268904, st: 233980, ews: 75811 },
        { year: 2023, general: 76835, obc: 88503, sc: 257032, st: 223380, ews: 72811 },
        { year: 2022, general: 73903, obc: 85103, sc: 247203, st: 215380, ews: 69711 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs'],
    courses: ['B.Tech', 'M.Tech'],
  ...
  },
  {
    ...
    fees: 54300,
    avgPackage: 300000,
    highestPackage: 650000,
    placementRate: 68,
    topRecruiters: ['TCS', 'Infosys', 'Wipro', 'Cognizant', 'Tech Mahindra'],
    cutoffs: {
      jee: [
        { year: 2024, general: 85094, obc: 98231, sc: 286904, st: 249980, ews: 80811 },
        { year: 2023, general: 81735, obc: 94303, sc: 274032, st: 238380, ews: 77811 },
        { year: 2022, general: 78703, obc: 90703, sc: 264203, st: 229380, ews: 74911 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs'],
    courses: ['B.Tech', 'M.Tech'],
  ...
  },
  {
    ...
    cutoffs: {
      jee: [
        ...
        { year: 2023, general: 72135, obc: 83103, sc: 242032, st: 210380, ews: 68811 },
        { year: 2022, general: 69303, obc: 79903, sc: 232203, st: 202380, ews: 66111 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs', 'Accessibility Support'],
    courses: ['B.Tech', 'M.Tech'],
    established: 1997,
    accreditation: 'NAAC B+'
  },
  {
    ...
    cutoffs: {
      jee: [
        { year: 2024, general: 138744, obc: 160000, sc: 350000, st: 300000, ews: 150000 },
        { year: 2023, general: 135759, obc: 156000, sc: 340000, st: 290000, ews: 145000 },
        { year: 2022, general: 130650, obc: 150000, sc: 330000, st: 280000, ews: 140000 }
      ]
    },
    facilities: ['Library', 'Sports Complex', 'Hostel', 'Labs', 'Cafeteria'],
    courses: ['B.Tech', 'M.Tech'],
  ...
  },
  {
    ...
    placementRate: 75,
    topRecruiters: ['TCS', 'Infosys', 'Wipro', 'Government', 'Banks'],
    cutoffs: {
      cuet: [
        { year: 2024, general: 300, obc: 270, sc: 240, st: 220, ews: 280 },
        { year: 2023, general: 290, obc: 260, sc: 230, st: 210, ews: 270 },
        { year: 2022, general: 280, obc: 250, sc: 220, st: 200, ews: 260 }
      ]
    },
    facilities: ['Library', 'Sports', 'Hostels', 'Hospital', 'Mosque'],
    courses: ['BA', 'B.Com', 'B.Sc', 'MBBS', 'Engineering'],
    established: 1920,
    accreditation: 'NAAC A+'
  },
  {
    ...
    placementRate: 72,
    topRecruiters: ['TCS', 'Infosys', 'Wipro', 'Government', 'Media'],
    cutoffs: {
      cuet: [
        { year: 2024, general: 80, obc: 70, sc: 60, st: 50, ews: 75 },
        { year: 2023, general: 75, obc: 65, sc: 55, st: 45, ews: 70 },
        { year: 2022, general: 70, obc: 60, sc: 50, st: 40, ews: 65 }
      ]
    },
    facilities: ['Library', 'Sports', 'Hostels', 'Hospital', 'Masjid'],
    courses: ['BA', 'B.Com', 'B.Sc', 'Engineering', 'Mass Communication'],
    established: 1920,
    accreditation: 'NAAC A++'
  }
];
...
export const mockTestScores: MockTestScore[] = [
  // JEE Main Mock Tests
  {
    id: 'jee-mock-1',
    examType: 'jee',
    testName: 'JEE Main Full Length Mock Test 1',
    date: '2025-01-15',
    maxScore: 300,
    averageScore: 95,
    difficulty: 'medium'
  },
  {
    id: 'jee-mock-2',
    examType: 'jee',
    testName: 'JEE Main Subject-wise Mock Test - Physics',
    date: '2025-01-20',
    maxScore: 100,
    averageScore: 45,
    difficulty: 'hard'
  },
  {
    id: 'jee-mock-3',
    examType: 'jee',
    testName: 'JEE Main Subject-wise Mock Test - Chemistry',
    date: '2025-01-22',
    maxScore: 100,
    averageScore: 50,
    difficulty: 'medium'
  },
  {
    id: 'jee-mock-4',
    examType: 'jee',
    testName: 'JEE Main Subject-wise Mock Test - Mathematics',
    date: '2025-01-25',
    maxScore: 100,
    averageScore: 40,
    difficulty: 'hard'
  ...
  // NEET Mock Tests
  {
    id: 'neet-mock-1',
    examType: 'neet',
    testName: 'NEET Full Length Mock Test 1',
    date: '2025-02-01',
    maxScore: 720,
    averageScore: 320,
    difficulty: 'medium'
  },
  {
    id: 'neet-mock-2',
    examType: 'neet',
    testName: 'NEET Subject-wise Mock Test - Biology',
    date: '2025-02-05',
    maxScore: 360,
    averageScore: 180,
    difficulty: 'medium'
  },
  {
    id: 'neet-mock-3',
    examType: 'neet',
    testName: 'NEET Subject-wise Mock Test - Physics & Chemistry',
    date: '2025-02-10',
    maxScore: 360,
    averageScore: 160,
    difficulty: 'hard'
  ...
  // CUET Mock Tests
  {
    id: 'cuet-mock-1',
    examType: 'cuet',
    testName: 'CUET General Test Mock 1',
    date: '2025-03-01',
    maxScore: 400,
    averageScore: 200,
    difficulty: 'medium'
  },
  {
    id: 'cuet-mock-2',
    examType: 'cuet',
    testName: 'CUET Domain Subject Mock Test',
    date: '2025-03-05',
    maxScore: 200,
    averageScore: 120,
    difficulty: 'hard'
